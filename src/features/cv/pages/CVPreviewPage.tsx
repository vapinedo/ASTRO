  ...
  const modifyPdf = async (cv: type.CV) => {
    ...
    switch (cv?.datosPersonales?.tipoIdentificacion) {
      case "cc":
        ...
        break;
      case "ce":
        drawText(page1, helveticaFont, "X", 113, 574);
        break;
      case "pas":
        drawText(page1, helveticaFont, "X", 147, 574);
        break;
    }
    drawText(
      page1,
    ...
    switch (cv?.datosPersonales?.sexo) {
      case "f":
        ...
        break;
      case "m":
        drawText(page1, helveticaFont, "X", 341, 573.4);
        break;
    }
    ...
    switch (cv?.datosPersonales?.tipolibretaMilitar) {
      case "primera":
        ...
        break;
      case "segunda":
        drawText(page1, helveticaFont, "X", 261.2, 543.2);
        break;
    }
    ...
    switch (cv?.formacionBasica.educacionBasica) {
      case "1":
        ...
        break;
      case "2":
        drawText(page1, helveticaFont, "X", 116.4, 317, 18);
        break;
      case "3":
        drawText(page1, helveticaFont, "X", 133, 317, 18);
        break;
      case "4":
        drawText(page1, helveticaFont, "X", 151, 317, 18);
        break;
      case "5":
        drawText(page1, helveticaFont, "X", 167.3, 317, 18);
        break;
      case "6":
        drawText(page1, helveticaFont, "X", 184.5, 317, 18);
        break;
      case "7":
        drawText(page1, helveticaFont, "X", 201.5, 317, 18);
        break;
      case "8":
        drawText(page1, helveticaFont, "X", 218, 317, 18);
        break;
      case "9":
        drawText(page1, helveticaFont, "X", 235.4, 317, 18);
        break;
      case "10":
        drawText(page1, helveticaFont, "X", 253.5, 317, 18);
        break;
      case "11":
    ...
    function printFormacionSuperior(
      ...
      if (formacionSuperior[0]) {
        switch (formacionSuperior[0].modalidadAcademica) {
          case "tecnica":
            drawText(page1, helveticaFont, "TC", 74, 200);
            break;
          case "tecnologica":
            drawText(page1, helveticaFont, "TL", 74, 200);
            break;
          case "tecnologa":
            drawText(page1, helveticaFont, "TE", 74, 200);
            break;
          case "unversitaria":
            drawText(page1, helveticaFont, "UN", 74, 200);
            break;
          case "especializacion":
            drawText(page1, helveticaFont, "ES", 74, 200);
            break;
          case "maestria":
            drawText(page1, helveticaFont, "MG", 74, 200);
            break;
          case "doctorado":
            drawText(page1, helveticaFont, "DOC", 74, 200);
            break;
        }
        drawText(
          page1,
          helveticaFont,
          formacionSuperior[0].numeroSemestresAprobados,
          132,
          200
        );
        // grauado
        switch (formacionSuperior[0].graduado) {
          case "si":
            ...
            break;
          case "no":
            drawText(page1, helveticaFont, "X", 207, 200);
            break;
        }
        drawText(
          page1,
          helveticaFont,
          formacionSuperior[0].tituloObtenido,
          230,
          200
        );
        ...
        drawText(
          page1,
          helveticaFont,
          formacionSuperior[0].numeroTarjetaProfesional,
          503.5,
          200,
          9
        );
      ...
      if (formacionSuperior[1]) {
        switch (formacionSuperior[1].modalidadAcademica) {
          case "tecnica":
            drawText(page1, helveticaFont, "TC", 74, 182.5);
            break;
          case "tecnologica":
            drawText(page1, helveticaFont, "TL", 74, 182.5);
            break;
          case "tecnologa":
            drawText(page1, helveticaFont, "TE", 74, 182.5);
            break;
          case "unversitaria":
            drawText(page1, helveticaFont, "UN", 74, 182.5);
            break;
          case "especializacion":
            drawText(page1, helveticaFont, "ES", 74, 182.5);
            break;
          case "maestria":
            drawText(page1, helveticaFont, "MG", 74, 182.5);
            break;
          case "doctorado":
            drawText(page1, helveticaFont, "DOC", 74, 182.5);
            break;
        }
        drawText(
          page1,
          helveticaFont,
          formacionSuperior[1].numeroSemestresAprobados,
          135,
          182.5
        );
        // grauado
        switch (formacionSuperior[1].graduado) {
          case "si":
            drawText(page1, helveticaFont, "X", 183, 182.5);
            break;
          case "no":
            drawText(page1, helveticaFont, "X", 207, 182.5);
            break;
        }
        drawText(
          page1,
          helveticaFont,
          formacionSuperior[1].tituloObtenido,
          230,
          182.5
        );
        drawText(
        ...
        drawText(
          page1,
          helveticaFont,
          formacionSuperior[1].numeroTarjetaProfesional,
          503.5,
          183.5,
          9
        );
      ...
      if (formacionSuperior[2]) {
        switch (formacionSuperior[2].modalidadAcademica) {
          case "tecnica":
            drawText(page1, helveticaFont, "TC", 74, 166);
            break;
          case "tecnologica":
            drawText(page1, helveticaFont, "TL", 74, 166);
            break;
          case "tecnologa":
            drawText(page1, helveticaFont, "TE", 74, 166);
            break;
          case "unversitaria":
            drawText(page1, helveticaFont, "UN", 74, 166);
            break;
          case "especializacion":
            drawText(page1, helveticaFont, "ES", 74, 166);
            break;
          case "maestria":
            drawText(page1, helveticaFont, "MG", 74, 166);
            break;
          case "doctorado":
            drawText(page1, helveticaFont, "DOC", 74, 166);
            break;
        }
        drawText(
          page1,
          helveticaFont,
          formacionSuperior[2].numeroSemestresAprobados,
          135,
          166
        );
        // grauado
        switch (formacionSuperior[2].graduado) {
          case "si":
            drawText(page1, helveticaFont, "X", 183, 166);
            break;
          case "no":
            drawText(page1, helveticaFont, "X", 207, 166);
            break;
        }
        drawText(
          page1,
          helveticaFont,
          formacionSuperior[2].tituloObtenido,
          230,
          166
        );
        drawText(
        ...
        drawText(
          page1,
          helveticaFont,
          formacionSuperior[2].numeroTarjetaProfesional,
          503.5,
          166,
          9
        );
      ...
      if (formacionSuperior[3]) {
        switch (formacionSuperior[3].modalidadAcademica) {
          case "tecnica":
            drawText(page1, helveticaFont, "TC", 74, 148.5);
            break;
          case "tecnologica":
            drawText(page1, helveticaFont, "TL", 74, 148.5);
            break;
          case "tecnologa":
            drawText(page1, helveticaFont, "TE", 74, 148.5);
            break;
          case "unversitaria":
            drawText(page1, helveticaFont, "UN", 74, 148.5);
            break;
          case "especializacion":
            drawText(page1, helveticaFont, "ES", 74, 148.5);
            break;
          case "maestria":
            drawText(page1, helveticaFont, "MG", 74, 148.5);
            break;
          case "doctorado":
            drawText(page1, helveticaFont, "DOC", 74, 148.5);
            break;
        }
        drawText(
          page1,
          helveticaFont,
          formacionSuperior[3].numeroSemestresAprobados,
          135,
          148.5
        );
        // grauado
        switch (formacionSuperior[3].graduado) {
          case "si":
            drawText(page1, helveticaFont, "X", 183, 148.5);
            break;
          case "no":
            drawText(page1, helveticaFont, "X", 207, 148.5);
            break;
        }
        drawText(
          page1,
          helveticaFont,
          formacionSuperior[3].tituloObtenido,
          230,
          148.5
        );
        drawText(
        ...
        drawText(
          page1,
          helveticaFont,
          formacionSuperior[3].numeroTarjetaProfesional,
          503.5,
          149,
          9
        );
      ...
      if (formacionSuperior[4]) {
        switch (formacionSuperior[4].modalidadAcademica) {
          case "tecnica":
            drawText(page1, helveticaFont, "TC", 74, 131);
            break;
          case "tecnologica":
            drawText(page1, helveticaFont, "TL", 74, 131);
            break;
          case "tecnologa":
            drawText(page1, helveticaFont, "TE", 74, 131);
            break;
          case "unversitaria":
            drawText(page1, helveticaFont, "UN", 74, 131);
            break;
          case "especializacion":
            drawText(page1, helveticaFont, "ES", 74, 131);
            break;
          case "maestria":
            drawText(page1, helveticaFont, "MG", 74, 131);
            break;
          case "doctorado":
            drawText(page1, helveticaFont, "DOC", 74, 131);
            break;
        }
        drawText(
          page1,
          helveticaFont,
          formacionSuperior[4].numeroSemestresAprobados,
          135,
          131
        );
        // grauado
        switch (formacionSuperior[4].graduado) {
          case "si":
            drawText(page1, helveticaFont, "X", 183, 131);
            break;
          case "no":
            drawText(page1, helveticaFont, "X", 207, 131);
            break;
        }
        drawText(
          page1,
          helveticaFont,
          formacionSuperior[4].tituloObtenido,
          230,
          131
        );
        drawText(
        ...
        drawText(
          page1,
          helveticaFont,
          formacionSuperior[4].numeroTarjetaProfesional,
          503.5,
          132,
          9
        );
    ...
    function printIdiomas(idiomas: type.Idioma[]) {
      if (idiomas[0]) {
        ...
        switch (idiomas[0].loHabla) {
          case "r":
            drawText(page1, helveticaFont, "X", 303, 71);
            break;
          case "b":
            drawText(page1, helveticaFont, "X", 320, 71);
            break;
          case "mb":
            drawText(page1, helveticaFont, "X", 337, 71);
            break;
        }
        switch (idiomas[0].loLee) {
          case "r":
            drawText(page1, helveticaFont, "X", 354.5, 71);
            break;
          case "b":
            drawText(page1, helveticaFont, "X", 371.5, 71);
            break;
          case "mb":
            drawText(page1, helveticaFont, "X", 388, 71);
            break;
        }
        switch (idiomas[0].loEscribe) {
          case "r":
            drawText(page1, helveticaFont, "X", 307, 71);
            break;
          case "b":
            drawText(page1, helveticaFont, "X", 423, 71);
            break;
          case "mb":
            drawText(page1, helveticaFont, "X", 440, 71);
            break;
        }
      }
      if (idiomas[1]) {
        ...
        switch (idiomas[1].loHabla) {
          case "r":
            drawText(page1, helveticaFont, "X", 303, 53.6);
            break;
          case "b":
            drawText(page1, helveticaFont, "X", 320, 53.6);
            break;
          case "mb":
            drawText(page1, helveticaFont, "X", 337, 53.6);
            break;
        }
        switch (idiomas[1].loLee) {
          case "r":
            drawText(page1, helveticaFont, "X", 354.5, 53.6);
            break;
          case "b":
            drawText(page1, helveticaFont, "X", 371.5, 53.6);
            break;
          case "mb":
            drawText(page1, helveticaFont, "X", 388, 53.6);
            break;
        }
        switch (idiomas[1].loEscribe) {
          case "r":
            drawText(page1, helveticaFont, "X", 307, 53.6);
            break;
          case "b":
            drawText(page1, helveticaFont, "X", 423, 53.6);
            break;
          case "mb":
            drawText(page1, helveticaFont, "X", 440, 53.6);
            break;
        }
      }
    }
    ...
    function printExoerienciaLaboral(
      ...
      if (experienciaLaboral[0]) {
        ...
        switch (experienciaLaboral[0].tipoEmpresa) {
          case "publica":
            drawText(page2, helveticaFont, "X", 344, 550.5);
            break;
          case "privada":
            drawText(page2, helveticaFont, "X", 390, 550.5);
            break;
        }
        ...
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[0].departamento,
          65,
          520
        );
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[0].municipio,
          242,
          520
        );
        drawText(
        ...
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[0].dependencia,
          242,
          461
        );
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[0].direccion,
          410,
          461
        );
      }
      ...
      if (experienciaLaboral[1]) {
        ...
        switch (experienciaLaboral[1].tipoEmpresa) {
          case "publica":
            ...
            break;
          case "privada":
            drawText(page2, helveticaFont, "X", 390, 419);
            break;
        }
        ...
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[1].departamento,
          65,
          390
        );
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[1].municipio,
          242,
          390
        );
        drawText(
        ...
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[1].dependencia,
          242,
          331
        );
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[1].direccion,
          410,
          331
        );
      }
      ...
      if (experienciaLaboral[2]) {
        ...
        switch (experienciaLaboral[2].tipoEmpresa) {
          case "publica":
            ...
            break;
          case "privada":
            drawText(page2, helveticaFont, "X", 390, 290);
            break;
        }
        ...
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[2].departamento,
          65,
          260
        );
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[2].municipio,
          242,
          260
        );
        drawText(
        ...
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[2].dependencia,
          242,
          201
        );
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[2].direccion,
          410,
          201
        );
      }
      ...
      if (experienciaLaboral[3]) {
        ...
        switch (experienciaLaboral[3].tipoEmpresa) {
          case "publica":
            ...
            break;
          case "privada":
            drawText(page2, helveticaFont, "X", 390, 160);
            break;
        }
        ...
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[3].departamento,
          65,
          129
        );
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[3].municipio,
          242,
          129
        );
        drawText(
        ...
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[3].dependencia,
          242,
          70
        );
        drawText(
          page2,
          helveticaFont,
          experienciaLaboral[3].direccion,
          410,
          70
        );
      }
    ...
    function printAniosExperiencia(
      ...
      const [fullYears, fullMonths] =
        printTotalAniosExperiencia(totalExperiencia);
