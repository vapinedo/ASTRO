          ...
          <div className="inner">
            <Stack direction="row" spacing={4}>
              ...
              <InputField
                ...
                error={
                  errors.experienciaLaboral &&
                  errors.experienciaLaboral[index]?.cargo?.message
                }
              />
              <InputField
                type="text"
                ...
                error={
                  errors.experienciaLaboral &&
                  errors.experienciaLaboral[index]?.dependencia?.message
                }
              />
            </Stack>
            ...
            <Stack direction="row" spacing={4} mt={4}>
              ...
              <InputField
                ...
                error={
                  errors.experienciaLaboral &&
                  errors.experienciaLaboral[index]?.direccion?.message
                }
              />
            </Stack>
            ...
            <Stack direction="row" spacing={4} mt={4}>
              <InputField
                ...
                error={
                  errors.experienciaLaboral &&
                  errors.experienciaLaboral[index]?.email?.message
                }
              />
              <InputField
                type="text"
                ...
                error={
                  errors.experienciaLaboral &&
                  errors.experienciaLaboral[index]?.telefono?.message
                }
              />
              <Controller
                control={control}
